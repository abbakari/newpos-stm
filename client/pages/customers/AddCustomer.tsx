...
export default function AddCustomer() {
  ...
  const handlePartialSave = () => {
    if (!validateBasicAndContact()) {
      alert("Please complete required fields in Basic Info and Contact & Address before saving.");
      return;
    }
    ...
    alert("Customer saved. Visit started and header notifications updated.");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if ((formData.visitType === "Service" || formData.visitType === "Sales") && !formData.desiredService) {
      alert("Please select the desired service for this visit.");
