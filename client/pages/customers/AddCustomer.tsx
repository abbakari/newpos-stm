      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Register a new customer with complete information for tracking and
            services
          </p>
        </div>
      </div>
                ...
                <div className="border rounded-lg p-4 space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <Input
                      ...
                      onChange={(e) =>
                        handleVehicleChange("make", e.target.value)
                      }
                    />
                    <Input
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleVehicleChange("plateNumber", e.target.value)
                      }
                    />
                    <Input
                      placeholder="Color"
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <Input
                      ...
                      onChange={(e) =>
                        handleVehicleChange("engineNumber", e.target.value)
                      }
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        handleVehicleChange("chassisNumber", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                {formData.vehicles.length > 0 && (
                  <div className="space-y-3">
                    <h4 className="font-medium">
                      Registered Vehicles ({formData.vehicles.length})
                    </h4>
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Plate: {vehicle.plateNumber} • Color:{" "}
                            {vehicle.color}
                          </p>
                        </div>
                        <Button
